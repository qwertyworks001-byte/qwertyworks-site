...
const animatedElements = document.querySelectorAll('.game-card, .partner-card, .bot-feature-card, .founder-section, .rule-item, .contact-card');
...
console.log('%c Welcome to Qwerty Works Gaming Studio! ', 'background: linear-gradient(135deg, #00f5ff 0%, #00d4ff 100%); color: #0a0e1a; font-size: 20px; padding: 10px; border-radius: 5px;');
console.log('%c Creating immersive Roblox experiences ', 'color: #00f5ff; font-size: 14px;');
